...
class DataTransformation:
    ...
    def get_data_transformation_object  (self):
        try:
            ...
            ## define the custom ranking for each catergoical variables
    ...
    def initiate_data_transformation(self, train_data_path, test_data_path):
        try:
            ...
            ## dividing the dataset into dependent and dependent features
            ## training data
            ...
            logging.info("Applying preprocessor object on training and testing data completed")
